...
//             <aside
//               className={`fixed md:relative w-64 bg-gray-900 text-white inset-y-0 left-0 transition-transform transform ${
//                 sidebarOpen ? 'translate-x-0' : '-translate-x-full'
//               } md:translate-x-0`}
//             >
//               <div className="p-4 px-6">
//                 <h4 className="text-base font-normal mb-6">Amanah Elements</h4>
//                 <nav>
//                   <ul>
//                     <li className="mb-2">
//                       <Link href="/data-user" className="block py-2 px-4 rounded hover:bg-gray-700">
//                         Data User
//                       </Link>
//                     </li>        
//                   </ul>
...
export default function RootLayout({
  ...
  const toggleSidebar = () => {
    if (window.innerWidth < 768) {
      ...
      // Untuk desktop, collapse/expand sidebar
      ...
      <body className={`${poppins.variable} antialiased`}>
        <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-1 bg-gray-100">
            ...
            <main className={`flex-1 p-6 ${sidebarCollapsed ? 'ml-auto' : 'ml-auto'}`}>
              {children}
            </main>
          </div>
